...
class TicTacToe:
    ...
    ''' start the game by creating an empty board using '_'
     as a representation of no move being made in that spot yet
    ...
    def create_board(self):
        ...
        for i in range(3):
            # print each character ending with space in between
            for j in range(3):
    ...
    # are the given positions for a move valid 
...
def main():
    ...
    # first is with minimax algorithm, second is with alpha-beta pruning
    t.game()
    t.game_prune()
